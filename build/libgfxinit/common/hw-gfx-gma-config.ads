...
private package HW.GFX.GMA.Config is
   ...
   PCH : constant Gen_PCH_Type := Cougar_Point;
   ...
   Ignore_Presence_Straps : constant Boolean := False;
   ...
   PCH_Cougar_Point  : constant Boolean := Gen_Ironlake and then PCH = Cougar_Point;

   Cougar_Point_On   : constant Boolean :=
     ((Gen_Ironlake and then PCH >= Cougar_Point) or Haswell_On);
   Cannon_Point_On   : constant Boolean := Skylake_On and then PCH >= Cannon_Point;
   ...
   Has_PP_Divisor_Reg            : constant Boolean :=
     (not Gen_Broxton and not Cannon_Point_On);
   Has_New_Backlight_Control     : constant Boolean := Gen_Broxton or Cannon_Point_On;

   ----------- PCH/FDI: ---------
   Has_PCH                       : constant Boolean := PCH /= No_PCH;
   ...
   function Has_FDI_Composite_Sel return Boolean is
     (CPU_Ivybridge);
   Has_New_FDI_Sink              : constant Boolean := Cougar_Point_On;
   function Has_New_FDI_Source return Boolean is
     (Ivybridge_On);
   Has_Trans_DP_Ctl              : constant Boolean := PCH_Cougar_Point;
   ...
   function Can_Switch_CDClk return Boolean is
     (Broadwell_On);
   Has_Fractional_RawClk         : constant Boolean := Cannon_Point_On;
   ...
   GMBUS_Alternative_Pins        : constant Boolean := Gen_Broxton or Cannon_Point_On;
