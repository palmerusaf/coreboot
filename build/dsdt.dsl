 ...
 *
 * Disassembly of build/dsdt.aml, Thu Jul 21 11:37:22 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00003859 (14425)
 *     Revision         0x02
 *     Checksum         0xC9
 *     OEM ID           "COREv4"
            ...
            Device (LPCB)
            {
                ...
                Scope (EC.BAT0)
                {
                    ...
                    Method (GETT, 1, NotSerialized)
                    {
                        If ((Arg0 == Zero))
                        {
                            Return (TSL0) /* \_SB_.PCI0.LPCB.EC__.TSL0 */
                        }

                        If ((Arg0 == One))
                        {
                            Return (TSH0) /* \_SB_.PCI0.LPCB.EC__.TSH0 */
                        }
                ...
                Scope (EC.BAT1)
                {
                    ...
                    Method (GETT, 1, NotSerialized)
                    {
                        If ((Arg0 == Zero))
                        {
                            Return (TSL1) /* \_SB_.PCI0.LPCB.EC__.TSL1 */
                        }
                ...
                Device (PS2M)
                {
                    Name (_HID, EisaId ("LEN0020"))  // _HID: Hardware ID
